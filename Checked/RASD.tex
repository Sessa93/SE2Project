...
\section{Requirements Specification}
    \subsection{Functional requirements}
      ...
      \begin{enumerate}
		...
		\end{enumerate}
	      ...
	      starting location
	      \item MyTaxiService(B) has to be able to manage a situation in which a mtaxi does not accept a ride/booking request within 2 mins.
	...
	\begin{enumerate}
	      ...
	      \item A mtaxi driver has to accept a ride/booking request within 2 mins
...
\section {Scenarios, Use Case and UML diagrams}
	...
	\subsection{Results}
		...
		\end{center}
		\newpage
		This graph shows the model produced by the execution of the predicate 
		\begin{center}
		\includegraphics[scale=0.42]{pred2.png}
		\end{center}
