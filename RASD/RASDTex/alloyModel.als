...
assert DelUndoAdd {
	all q,q1,q2: Queue, t: Mtaxi |t not in q.taxies and addTaxiToQueue[q,q1,t]
		 and delTaxiFromQueue[q1,q2,t] implies q.taxies = q2.taxies
}
...
pred addTaxiToQueue(q,q1: Queue, t: Mtaxi) {
	q1.taxies = q.taxies + t
}
run  addTaxiToQueue for 5

//Simulates the deletion of a taxi from a queue
pred delTaxiFromQueue(q,q1: Queue, t: Mtaxi) {
	q1.taxies = q.taxies - t
}
