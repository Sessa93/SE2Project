...
\title{\textbf{R}equirements \textbf{A}nalysis and \textbf{S}pecifications \textbf{D}ocument \\ \vspace{1cm} \large{Version 1.1}} 
\author{Giorgio Pea(Mat. 853872), Andrea Sessa(Mat. 850082)}
\date{13/11/2015} % Activate to display a given date or no date (if empty),
...
\section{Introduction}
  ...
  \subsection{Terms and definitions}
	\begin{description}
	      ...
	      \item [Administrator] \hfill \\ A supervisor in charge of managing non-automated procedures
    ...
    \subsection{Functional requirements}
      ...
      \begin{enumerate}
		...
		\end{enumerate}
	      ...
	      \item ADMINISTRATOR
		 \begin{enumerate}
			\item View taxies reports
			\item Reactivate accidented taxies
		\end{enumerate}
