...
\title{\textbf{R}equirements \textbf{A}nalysis and \textbf{S}pecifications \textbf{D}ocument \\ \vspace{1cm} \large{Version 1.2}}
\author{Giorgio Pea(Mat. 853872), Andrea Sessa(Mat. 850082)}
\date{3/12/2015} % Activate to display a given date or no date (if empty),
