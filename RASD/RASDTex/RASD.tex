...
\lstdefinelanguage{Alloy}{
  keywords={sig, abstract, extends, one, some, all, lone, set, pred, fact, assert, check, implies, and, or, no, run},
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]',
  morestring=[b]",
...
\date{18/01/2016} % Activate to display a given date or no date (if empty),
...
\section {Scenarios, Use Case and UML diagrams}
	...
	\subsection{Sigs}
		...
		\lstinputlisting[language=Alloy, firstnumber=1, firstline=1, lastline=94]{alloyModel.als}
	\newpage
	\subsection{Facts}
		%\includegraphics[scale=0.78]{fact1.png}
		%\newpage
		%\includegraphics[scale=0.8]{fact2.png}
		\lstinputlisting[language=Alloy, firstnumber=97, firstline=97, lastline=189]{alloyModel.als}
	\subsection{Assertions}
		%\includegraphics[scale=0.8]{assertions.png}
		\lstinputlisting[language=Alloy, firstnumber=193, firstline=193, lastline=225]{alloyModel.als}
	\newpage
	\subsection{Predicates}
		%\includegraphics[scale=0.8]{preds.png}
		\lstinputlisting[language=Alloy, firstnumber=231, firstline=231, lastline=264]{alloyModel.als}
	\newpage
	\subsection{Results}
